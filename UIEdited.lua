...
local git_version = "https://raw.githubusercontent.com/Skillmeister/Gamesense-like-UI/master/version.txt"
local git_repository = "https://raw.githubusercontent.com/Skillmeister/Gamesense-like-UI/master/SenseUI Menu (FPS BOOST) Edited.lua"
local app_awusers = "http://api.shadyretard.io/awusers"
...
local sniper_select = 1;
local shotgun_select = 1;
